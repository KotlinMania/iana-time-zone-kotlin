...
kotlin {
    ...
    val xcf = XCFramework("IanaTimeZone")
    ...
    swiftExport {
        moduleName = "IanaTimeZone"
        flattenPackage = "io.github.kotlinmania.ianatimezone"
    }

    android {
        namespace = "io.github.kotlinmania.ianatimezone"
        compileSdk = 34
        minSdk = 24
    ...
    sourceSets {
        val commonMain by getting {
            dependencies {
                ...
                // std::fs equivalent — used by the commonMain port of
                // tz_linux.rs (read_link → SystemFileSystem.resolve,
                // read_to_string → Source.readString).
        ...
        val androidMain by getting {
            dependencies {
                implementation("io.github.kotlinmania:android-system-properties-kotlin:0.1.0")
            }
        }
...
mavenPublishing {
    ...
    coordinates(group.toString(), "iana-time-zone-kotlin", version.toString())

    pom {
        name.set("iana-time-zone-kotlin")
    ...
    doFirst {
        ...
        if (sourceFiles.isEmpty()) {
            ...
            sentinelFile.writeText(
                ...
                package io.github.kotlinmania.ianatimezone.codeql
...
val fullTargetBuildTaskNames = setOf(
    ...
    "assembleIanaTimeZoneXCFramework",
)
