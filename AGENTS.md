...
This file is the quick-reference operating contract for iana-time-zone-kotlin. The longer
...
iana-time-zone-kotlin is a Kotlin Multiplatform port of the upstream Rust crate or module
[`iana-time-zone`](https://crates.io/crates/iana-time-zone). Upstream Rust is the behavioral oracle while the
