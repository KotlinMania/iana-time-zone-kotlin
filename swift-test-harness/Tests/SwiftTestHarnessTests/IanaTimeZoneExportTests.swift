...
// of the pipeline:
//
//   1. `embedSwiftExportForXcode` produced `IanaTimeZone.swiftmodule/`
...
//      `import IanaTimeZone` above would fail at compile time.
//
//   2. The static archive `libIanaTimeZone.a` (produced by the
...
//      architecture arm64".
//
//   3. The Kotlin `swiftExport { moduleName = "IanaTimeZone" }` and
//      `flattenPackage = "io.github.kotlinmania.ianatimezone"` configuration in
...
//      via the `IanaTimeZoneLibrary` product.
//
...
final class IanaTimeZoneExportTests: XCTestCase {
    func testSwiftModuleLoads() throws {
        XCTAssertTrue(true, "IanaTimeZone swift module imported cleanly")
    }
}
